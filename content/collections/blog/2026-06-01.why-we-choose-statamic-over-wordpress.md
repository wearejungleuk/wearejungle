...
content:
  -
    ...
    content:
      -
        type: text
        text: "Let's be clear from the start: we have nothing against WordPress. We've built on it for over a decade, and we still do when it's the right tool for the job. But for most of the websites we build today - brochure sites, portfolio sites, marketing sites - we choose Statamic first. Here's why."
  -
    type: heading
    attrs:
      level: 2
  ...
  -
    ...
    content:
      -
        type: text
        text: 'The single biggest source of WordPress vulnerabilities is its plugin ecosystem. There are over 60,000 plugins in the WordPress repository, and they vary wildly in quality and update frequency. A single outdated plugin with a known vulnerability is enough to get a site compromised - which is '
      -
        type: text
        marks:
          -
